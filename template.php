 ...
 */
function syddjurs_dk_preprocess_html(&$variables) {
 ...
 */
function syddjurs_dk_menu_link(array $variables) {
 ...
 */
function syddjurs_dk_breadcrumb($variables) {
 ...
 */
function syddjurs_dk_preprocess_region(&$vars) {
  global $user;
 ...
 * tekst i søgefelt
 */
function syddjurs_dk_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function syddjurs_dk_filefield_item($file, $field) {
